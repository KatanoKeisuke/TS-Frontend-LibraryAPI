  ...
  return (
    <div className="p-8 max-w-4xl mx-auto space-y-8">
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <Card className="hover:shadow-lg transition-shadow">
          <CardHeader>
            <CardTitle>書籍キーワード検索</CardTitle>
            <CardDescription>登録されている書籍をキーワードで検索します</CardDescription>
          </CardHeader>
          <CardContent>
            <Button asChild className="w-full">
        ...
        <Card className="hover:shadow-lg transition-shadow">
          ...
          <CardContent>
            <Button asChild className="w-full">
              <Link href="/api/books/register">登録画面へ進む</Link>
            </Button>
          </CardContent>
        </Card>
        ...
        <Card className="hover:shadow-lg transition-shadow">
          ...
          <CardContent>
            <Button asChild variant="secondary" className="w-full">
              <Link href="/api/books/update">変更画面へ進む</Link>
            </Button>
          </CardContent>
        </Card>
